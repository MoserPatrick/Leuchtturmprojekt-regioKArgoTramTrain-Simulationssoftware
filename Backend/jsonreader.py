...
class jsonreader:
    ...
    def get_lines_and_stations():
        ...
        d.close
        return trias_id_list, numbers

    #print(numbers)
    #adds lines to the corret stations
    def add_lines_to_stations(stationlist, trias_id_list, numbers):
    ...
    def sort_stationlist(stationlist, trias_id_list):
    ...
    # Berechnung
    def calculate_weight_and_create_connections(sorted_stationlist, numbers):
        sum = 0
        lat1 = 0
        long1 = 0
        lat2 = 0
